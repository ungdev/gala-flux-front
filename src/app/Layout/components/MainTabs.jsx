...
export default class MainTabs extends React.Component {
     ...
     * @return {string} The value of the active tab (or null)
     */
        ...
        return (
            <div>
                ...
                { this.state.tabs.filter(tab => (tab.tablet !== false)).length > 1 &&
                    <Tabs className="AdminPage__tabs show-sm hide-xs" onChange={v => browserHistory.push(v)} value={this.state.tabletValue}>
                ...
                { this.state.tabs.filter(tab => (tab.desktop !== false)).length > 1 &&
                    <Tabs className="AdminPage__tabs hide-sm hide-xs" onChange={v => browserHistory.push(v)} value={this.state.desktopValue}>
                        { this.state.tabs.map((tab, i) => (
                            tab.desktop !== false &&
                            <Tab
                                key={i}
