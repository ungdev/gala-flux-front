    ...
    render() {
        ...
        return (
            <div className={this.props.className}>
                <SelectableList onChange={this._handleChange} value={'route'} className="AdminMenu">
                    ...
                    <div className="show-xs">
                        <Channels route={this.state.route} onChange={(channel) => this.props.onChange('chat.channel', {channel: channel})} />
                    </div>
